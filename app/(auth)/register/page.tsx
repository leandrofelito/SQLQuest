      ...
      <div className="min-h-screen bg-[#080a0f] flex flex-col items-center justify-center px-6">
        ...
        <div className="relative z-10 w-full max-w-sm sm:max-w-md">
          <div className="flex justify-center items-center gap-3 mb-8">
            <img src="/brand/logooficialSQLQUESTpng-Photoroom.png" alt="" className="w-11 h-11" />
            <span className="text-3xl font-bold text-[#a78bfa] font-syne">SQL<span className="text-[#facc15]">Quest</span></span>
          </div>
    ...
    <div className="min-h-screen bg-[#080a0f] flex flex-col items-center justify-center px-6 pt-10">
      ...
      <div className="relative z-10 w-full max-w-sm sm:max-w-md space-y-6">
        ...
        <div className="flex justify-center items-center gap-3 pt-2 pb-0">
          <img src="/brand/logooficialSQLQUESTpng-Photoroom.png" alt="" className="w-12 h-12" />
          <span className="text-3xl font-bold text-[#a78bfa] font-syne">SQL<span className="text-[#facc15]">Quest</span></span>
        </div>
